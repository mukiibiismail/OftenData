...
Imports System.Text
Public Class frmChangepassAll

    Private Sub allusers()
        Try
    ...
    Private Sub frmChangepassAll_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Anime(Me.Handle.ToInt32)
    End Sub
    Private Sub frmChangepassAll_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Me.allusers()
        lblUser.Text = cbouser.SelectedValue.ToString
    ...
    Private Sub cbouser_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cbouser.SelectedIndexChanged
        lblUser.Text = cbouser.SelectedValue.ToString
    End Sub
