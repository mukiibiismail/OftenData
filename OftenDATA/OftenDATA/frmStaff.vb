...
Public Class frmStaff
    ...
    Private Sub AddStaff()
        Try
            sqL = "INSERT INTO Staff(Lastname, Firstname, MI, Address, ContactNo, Positions) VALUES('" & txtLastname.Text & "', '" & txtFirstname.Text & "', '" & txtMI.Text & "', '" & txtAddress.Text & "', '" & txtContactNo.Text & "', '" & txtPosition.Text & "')"
            ConnDB()
            cmd = New OleDbCommand(sqL, conn)
            Dim i As Integer
    ...
    Private Sub UpdateStaff()
        Try
            sqL = "Update Staff SET Lastname ='" & txtLastname.Text & "', Firstname = '" & txtFirstname.Text & "', MI = '" & txtMI.Text & "', Address= '" & txtAddress.Text & "', ContactNo = '" & txtContactNo.Text & "', Positions = '" & txtPosition.Text & "' WHERE StaffID = " & txtStaffID.Text & ""
            ConnDB()
            cmd = New OleDbCommand(sqL, conn)
            Dim i As Integer
            i = cmd.ExecuteNonQuery
    ...
    Private Sub frmStaff_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
